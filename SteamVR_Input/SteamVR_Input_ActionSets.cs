...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_chris_ur5_3f_gripper p_chris_ur5_3f_gripper;
        ...
        public static SteamVR_Input_ActionSet_chris_ur5_3f_gripper chris_ur5_3f_gripper
        {
            get
            {
                return SteamVR_Actions.p_chris_ur5_3f_gripper.GetCopy<SteamVR_Input_ActionSet_chris_ur5_3f_gripper>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_chris_ur5_3f_gripper = ((SteamVR_Input_ActionSet_chris_ur5_3f_gripper)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_chris_ur5_3f_gripper>("/actions/chris_ur5_3f_gripper")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.chris_ur5_3f_gripper};
        }
    }
}
